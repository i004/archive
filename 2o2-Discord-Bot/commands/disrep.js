...
module.exports = class Disrep extends BaseCommand {
    constructor (client) {
        super({
            client,
            name: 'Lower Reputation',
            type: 'USER',
            nameLocalizations: {
                ru: 'Понизить репутацию',
    ...
    async run (i) {
        ...
        await i.reply({ content: `<:ic_downvote:973214298354634772> Репутация **${user.tag}** была понижена.` });
    }
}